<?php
  ...
  require __DIR__. '/fund_control_required.php';
  ...
  <div class="row">
    ...
    <div class="col">           
                <div class="form-group">
                    ...
                    value="<?=htmlentities($row['e_proname']) ?>">
                ...
                <img src="/fund_project/parts/e_img/
<?= $row['e_pic'] ?>" alt="" id="e_pic_img" width="80%" class="d-flex justify-content-center"><br>
<button type="button" class="btn btn-info btn-sm btn-block "
                onclick="file_input.click()" >更換產品圖</button>
                </div>
        </div>
        ...
        <div class="col">
                ...
                <div class="form-group">
                    ...
                    value="<?=htmlentities($row['e_lowprice']) ?>">
                    <small class="form-text error-msg"></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    value="<?=htmlentities($row['e_goal']) ?>">
                    <small class="form-text error-msg"></small>
                </div>

                <div class="form-group">
                    <label for="time1"><span class="red-stars">**</span>開始時間</label>
                    <input type="datetime" class="form-control" id="time1" name="e_start_time" required
                    value="<?=htmlentities($row['e_start_time']) ?>">
                    <small class="form-text error-msg"></small>
                </div>

                <div class="form-group">
                    <label for="time2"><span class="red-stars">**</span>結束時間</label>
                    <input type="datetime" class="form-control" id="time2" name="e_end_time" required
                    value="<?=htmlentities($row['e_end_time']) ?>">
                    <small class="form-text error-msg"></small>
                </div>

                <div class="form-group">
                    <label for="time3"><span class="red-stars">**</span>產品實踐時間</label>
                    <input type="date" class="form-control" id="time3" name="e_realize_time" required
                    value="<?=htmlentities($row['e_realize_time']) ?>">
                    <small class="form-text error-msg"></small>
                </div>
        ...
        file_input.addEventListener('change', function (event) {
            ...
            fetch('upload-api.php', {
                ...
                .then(obj => {
                    ...
                    document.querySelector('#e_pic_img').src = '/fund_project/parts/e_img/' + obj.filename;
                });
        });
